...
class place_a2b_right(Base_Task):
    ...
    def load_actors(self):
        ...
        def get_available_model_ids(modelname):
            asset_path =  os.path.join(ROOT_PATH , f"assets/objects", modelname) #asset_path = os.path.join(ROOT_PATH , f"assets/objects", modelname) os.path.join("assets/objects", modelname)
